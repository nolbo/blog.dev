    ...
    theme: {
        ...
        extend: {
            textColor: {
                ...
                "purple-default": "var(--text-purple-default)",
                "purple-layer1": "var(--text-purple-layer1)",
            ...
            backgroundColor: {
                ...
                "purple-default": "var(--bg-purple-default)",
                "purple-default-hover": "var(--bg-purple-default-hover)",
                "purple-layer1": "var(--bg-purple-layer1)",
                "purple-layer1-hover": "var(--bg-purple-layer1-hover)",
            ...
            borderColor: {
                ...
                "purple-default": "var(--border-purple-default)",
            ...
            spacing: {
                ...
                "content-x-xl": "32px",
                "article-content-x-default": "16px",
                "article-content-x-md": "96px",
                "article-content-x-lg": "calc((100vw - var(--width-article-md)) / 2 + 32px)",
                "article-content-x-xl": "32px",
                ...
                "article-md": "var(--width-article-md)",
                "header-h": "64px",
                "sidebar-w-md": "225px",
                "sidebar-w-lg": "225px",
                none: "0"
